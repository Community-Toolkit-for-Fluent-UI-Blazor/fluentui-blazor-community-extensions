...
/// used.</param>
internal sealed class Barcode2DComposer<TBarcodeOptions>(
    IBarcodeEncoder<Barcode2DPayload, TBarcodeOptions> encoder,
    Func<string> barcodeData,
    TBarcodeOptions barcodeOptions,
    Barcode2DLayerComposer<TBarcodeOptions>? composer = null
    ) : ISurfaceComposer<BarcodeRenderingOptions> where TBarcodeOptions : IBarcode2DOptions
{
    /// <summary>
        ...
        BarcodeRenderingOptions options)
    {
        ...
        var realComposer = composer ?? new Barcode2DLayerComposer<TBarcodeOptions>();

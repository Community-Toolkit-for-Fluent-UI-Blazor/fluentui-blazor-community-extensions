...
internal static class ChartTypeInfo
{
    ...
    public static readonly Dictionary<ChartType, ChartCategory> Categories = new(EqualityComparer<ChartType>.Default)
    {
        ...
        [ChartType.Line] = ChartCategory.Category,
        [ChartType.Area] = ChartCategory.Category,
        [ChartType.Step] = ChartCategory.Category,
        ...
        [ChartType.StackedStep] = ChartCategory.Category,
        [ChartType.Stacked100Step] = ChartCategory.Category,

...
{
    /// <summary>
    /// Initialize a new instance of the <see cref="SchedulerMonthView"/> component with the specified library configuration.
    /// </summary>
    /// <param name="configuration">The library configuration to be used by the component.</param>
    public SchedulerMonthView(LibraryConfiguration configuration)
        : base(configuration)
    { }

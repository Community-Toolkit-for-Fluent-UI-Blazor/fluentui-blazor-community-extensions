...
/// </summary>
public sealed class AxisPayload : ILayerPayload, IEquatable<AxisPayload>
{
    /// <summary>
    /// Gets the payload that defines the geometry and properties of the X-axis.
    /// </summary>
    public AxisGeometryPayload? XAxis { get; init; }

    /// <summary>
    /// Gets the payload that defines the geometry and properties of the Y-axis.
    /// </summary>
    public AxisGeometryPayload? YAxis { get; init; }
    ...
    public AxesLayerOrder Layer { get; init; } = AxesLayerOrder.Background;
    ...
    /// <inheritdoc />
    public bool Equals(AxisPayload? other)
    {
        if (other is null)
        {
            return false;

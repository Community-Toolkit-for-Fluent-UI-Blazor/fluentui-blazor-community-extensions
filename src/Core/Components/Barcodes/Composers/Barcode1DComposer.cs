...
internal sealed class Barcode1DComposer<TBarcodeOptions>(
    IBarcodeEncoder<Barcode1DPayload, TBarcodeOptions> encoder,
    Func<string> barcodeData,
    TBarcodeOptions barcodeOptions,
    Barcode1DLayerComposer<TBarcodeOptions>? composer = null
    ) : ISurfaceComposer<BarcodeRenderingOptions>
{
    /// <summary>
        ...
        BarcodeRenderingOptions options)
    {
        ...
        var realComposer = composer ?? new Barcode1DLayerComposer<TBarcodeOptions>();

...
public record CookieLabels
{
    ...
    /// <summary>
    /// Gets or sets the description of the cookie consent dialog.
    /// </summary>
    public string Description { get; set; } = "Our site uses cookies to enhance your browsing experience, analyze traffic, and personalize the content offered. These small files stored on your device allow, for example, to remember your preferences, facilitate access to your account, or provide you with advertisements tailored to your interests.<br/><br/>By continuing to browse this site, you accept the use of these cookies. You can change your settings at any time or consult our privacy policy to learn more about their management.";

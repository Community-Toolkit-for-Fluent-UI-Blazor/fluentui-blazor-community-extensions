...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SchedulerDayView"/> class using the specified library configuration.
    /// </summary>
    /// <param name="configuration">The configuration settings to be used for initializing the <see cref="SchedulerDayView"/>. Cannot be null.</param>
    public SchedulerDayView(LibraryConfiguration configuration)
        : base(configuration)
    { }

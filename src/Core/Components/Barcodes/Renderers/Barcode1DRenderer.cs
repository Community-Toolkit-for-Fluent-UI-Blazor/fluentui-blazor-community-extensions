...
internal sealed class Barcode1DRenderer<TBarcodeOptions>(
    IBarcodeEncoder<Barcode1DPayload, TBarcodeOptions> encoder,
    Func<string> barcodeData,
    TBarcodeOptions barcodeOptions,
    Barcode1DComposer<TBarcodeOptions>? composer = null
    ) : ISurfaceRenderer<BarcodeRenderingOptions>
{
    /// <summary>
        ...
        BarcodeRenderingOptions options)
    {
        ...
        var realComposer = composer ?? new Barcode1DComposer<TBarcodeOptions>();

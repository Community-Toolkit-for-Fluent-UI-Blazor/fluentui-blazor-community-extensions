export function getDeviceInfo() {
  var
    ...
    os = /Windows NT 10/.test(userAgent) ? "Windows10" : /Windows NT 6\.0/.test(userAgent) ? "WindowsVista" : /Windows NT 6\.1/.test(userAgent) ? "Windows7" : /Windows NT 6\.\d/.test(userAgent) ? "Windows8" : /Windows NT 5\.1/.test(userAgent) ? "WindowsXp" : /Windows NT [1-5]\./.test(userAgent) ? "WindowsNT" : /Mac/.test(userAgent) ? "Mac" : /Linux/.test(userAgent) ? "Linux" : /X11/.test(userAgent) ? "Nix" : "Undefined",

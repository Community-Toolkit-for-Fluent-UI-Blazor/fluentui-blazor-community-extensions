...
internal class Barcode1DStackedLayerComposer<TBarcodeOptions>
    : IBarcodeLayerComposer<Barcode1DStackedPayload, TBarcodeOptions> where TBarcodeOptions : IBarcode1DStackedOptions
{
    /// <inheritdoc />

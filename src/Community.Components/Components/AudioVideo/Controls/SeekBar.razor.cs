...
public partial class SeekBar : FluentComponentBase, IAsyncDisposable
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            _module = await JS.InvokeAsync<IJSObjectReference>("import", "./_content/FluentUI.Blazor.Community.Components/Components/AudioVideo/Controls/SeekBar.razor.js");
    ...
    private async Task SeekToAsync(double time, bool preview = false)
    {
        ...
        {
            await _module.InvokeVoidAsync("fluentCxSeekBar.getThumbnail", Id, VideoReference?.Element, _canvasElement, _thumbnailElement);
        }

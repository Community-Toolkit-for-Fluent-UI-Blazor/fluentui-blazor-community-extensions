...
public sealed record ChartAnimationStrategies
{
    /// <summary>
    ...
    /// </summary>
    public ChartAnimationStrategy InitialAppear { get; init; } = ChartAnimationStrategy.DefaultInitial;
    ...
    public ChartAnimationStrategy Update { get; init; } = ChartAnimationStrategy.DefaultUpdate;
    ...
    public ChartAnimationStrategy Remove { get; init; } = ChartAnimationStrategy.None;
    ...
    public ChartAnimationStrategy HoverIn { get; init; } = ChartAnimationStrategy.DefaultHoverIn;

    /// <summary>
    /// Gets the animation strategy to use when the pointer leaves a chart element.
    /// </summary>
    public ChartAnimationStrategy HoverOut { get; init; } = ChartAnimationStrategy.DefaultHoverOut;
    ...
    public ChartAnimationStrategy SelectIn { get; init; } = ChartAnimationStrategy.DefaultSelectIn;

    /// <summary>
    /// Gets the animation strategy to use when deselecting chart elements.
    /// </summary>
    public ChartAnimationStrategy SelectOut { get; init; } = ChartAnimationStrategy.DefaultSelectOut;

    /// <summary>
    /// Gets the animation strategy to use when deselecting chart elements.
    /// </summary>
    public ChartAnimationStrategy PressIn { get; init; } = ChartAnimationStrategy.DefaultPressIn;

    /// <summary>
    /// Gets the animation strategy to use when pressing out chart elements.
    /// </summary>
    public ChartAnimationStrategy PressOut { get; init; } = ChartAnimationStrategy.DefaultPressOut;

    /// <summary>
    /// Gets the animation strategy to use when enabling chart elements.
    /// </summary>
    public ChartAnimationStrategy Enable { get; init; } = ChartAnimationStrategy.DefaultEnable;

    /// <summary>
    /// Gets the animation strategy to use when disabling chart elements.
    /// </summary>
    public ChartAnimationStrategy Disable { get; init; } = ChartAnimationStrategy.DefaultDisable;
}

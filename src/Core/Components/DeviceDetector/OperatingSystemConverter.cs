...
/// </summary>
internal sealed class OperatingSystemConverter : JsonConverter<OperatingSystem>
{
    /// <inheritdoc />
    ...
    /// <inheritdoc />
    public override void Write(Utf8JsonWriter writer, OperatingSystem value, JsonSerializerOptions options) => throw new NotImplementedException();
}

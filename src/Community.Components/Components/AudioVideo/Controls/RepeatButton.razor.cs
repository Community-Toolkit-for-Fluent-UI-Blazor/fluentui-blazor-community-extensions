...
public partial class RepeatButton : FluentComponentBase
{
    ...
    {
        AudioVideoRepeatMode.SingleOnce => SingleOnceLabel ?? "Play Single Once",
        AudioVideoRepeatMode.SingleLoop => SingleLoopLabel ?? "Repeat Single",
        AudioVideoRepeatMode.PlaylistOnce => PlaylistOnceLabel ?? "Play Playlist Once",
        AudioVideoRepeatMode.PlaylistLoop => PlaylistLoopLabel ?? "Repeat Playlist",
    ...
    /// cref="AudioVideoRepeatMode.SingleOnce"/> → <see cref="AudioVideoRepeatMode.SingleLoop"/> →  <see
    /// cref="AudioVideoRepeatMode.PlaylistOnce"/> → <see cref="AudioVideoRepeatMode.PlaylistLoop"/> →  <see
    /// cref="AudioVideoRepeatMode.SingleOnce"/>. After updating the repeat mode, the component's state is
    /// refreshed.</remarks>
    private async Task OnChangeRepeatModeAsync()
    {
        _repeatMode = _repeatMode switch
        {
            AudioVideoRepeatMode.SingleOnce => AudioVideoRepeatMode.SingleLoop,
            AudioVideoRepeatMode.SingleLoop => AudioVideoRepeatMode.PlaylistOnce,
            AudioVideoRepeatMode.PlaylistOnce => AudioVideoRepeatMode.PlaylistLoop,
            AudioVideoRepeatMode.PlaylistLoop => AudioVideoRepeatMode.SingleOnce,
            _ => AudioVideoRepeatMode.SingleOnce
        };

        RepeatIcon = _repeatMode switch
        {
            AudioVideoRepeatMode.SingleOnce => SingleOnceIcon,
            AudioVideoRepeatMode.SingleLoop => SingleLoopIcon,
            AudioVideoRepeatMode.PlaylistOnce => PlaylistOnceIcon,
            AudioVideoRepeatMode.PlaylistLoop => PlaylistLoopIcon,
            _ => SingleOnceIcon
        };

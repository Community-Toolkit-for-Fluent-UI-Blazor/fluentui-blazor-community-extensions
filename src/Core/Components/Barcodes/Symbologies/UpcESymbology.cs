...
public sealed class UpcESymbology : ComponentBase, ISymbology
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the numeric base used for number representation.
    /// </summary>
    [Parameter]
    ...
    /// </summary>
    public Symbology Symbology => Symbology.UpcE;
    ...
    protected override void OnInitialized()
    {
        ...
        if (Parent is null)
        {
            throw new InvalidOperationException("The Upc-E Symbology component must be used within a FluentCxBarcode component.");
        }

...
/// <summary>
/// Represents the context of the <see cref="ManageCookie"/> dialog.
/// </summary>
...
public record CookieDialogContext(
    IEnumerable<CookiePolicyEntry> Items,
    CookieLabels Labels,
    RenderFragment<CookiePolicyEntry>? ItemTemplate = null
);

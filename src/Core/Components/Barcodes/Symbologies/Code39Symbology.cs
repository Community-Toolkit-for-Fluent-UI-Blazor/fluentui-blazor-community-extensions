...
/// principles.</remarks>
public sealed class Code39Symbology : ComponentBase, ISymbology
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the ratio used to determine when the layout is considered wide.
    /// </summary>
    [Parameter]
    public double WideRatio { get; set; } = 3.0;

    /// <summary>
    /// Gets or sets a value indicating whether checksum validation is enabled for the operation.
    /// </summary>
    [Parameter]
    ...
    /// </summary>
    public Symbology Symbology => Symbology.Code39;
    ...
    protected override void OnInitialized()
    {
        ...
        if (Parent is null)
        {
            throw new InvalidOperationException("The Code39Symbology component must be used within a FluentCxBarcode component.");
        }

...
public sealed class Stacked100StepSerie
    : SerieBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Stacked100StepSerie"/> class with the specified library configuration.
    /// </summary>
    /// <param name="configuration">The configuration settings for the Fluent UI Blazor library.</param>
    public Stacked100StepSerie(LibraryConfiguration configuration)
        : base(configuration)
    {
        Id = Identifier.NewId();
    }
    ...
    /// <inheritdoc />
    protected internal override ChartType ChartType => ChartType.Stacked100Step;
    ...
    /// <summary>
    /// Gets or sets the configuration options for the step series.
    /// </summary>
    [Parameter]
    ...
    protected internal override ChartSerie Create()
    {
        var cls = new Charts.Series.LineSerie
        {
            ...
            Options = Options,
            LineType = LineChartType.Stacked100Step
        };

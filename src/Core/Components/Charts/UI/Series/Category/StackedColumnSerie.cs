...
/// </summary>
public sealed class StackedColumnSerie
    : SerieBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="StackedColumnSerie"/> class with the specified library configuration.
    /// </summary>
    /// <param name="configuration">The configuration settings for the Fluent UI Blazor library.</param>
    public StackedColumnSerie(LibraryConfiguration configuration)
        : base(configuration)
    {
        Id = Identifier.NewId();
    }
    ...
    /// <inheritdoc />
    protected internal override ChartType ChartType => ChartType.StackedColumn;
    ...
    /// <summary>
    /// Gets or sets the configuration options for the column series.
    /// </summary>
    [Parameter]
    public ColumnSerieOptions? Options { get; init; } = new();

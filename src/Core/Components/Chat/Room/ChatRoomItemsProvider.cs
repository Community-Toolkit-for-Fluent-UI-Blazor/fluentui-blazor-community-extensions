...
public delegate ValueTask<IEnumerable<ChatRoom>> ChatRoomItemsProvider<TChatRoom>(
    ChatRoomItemsRequest<TChatRoom> request,
    CancellationToken cancellationToken = default) where TChatRoom : IChatRoomCapabilities;

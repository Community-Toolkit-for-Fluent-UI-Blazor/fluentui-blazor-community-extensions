...
public partial class SchedulerAgendaView<TItem>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SchedulerAgendaView{TItem}"/> class with the specified library configuration.
    /// </summary>
    /// <param name="configuration">Configuration settings for the component, including theme and other library-specific options. This parameter is required for proper initialization of the component.</param>
    public SchedulerAgendaView(LibraryConfiguration configuration)
        : base(configuration)
    {
    }
    ...
    /// <param name="culture">The culture information used for formatting the time strings. </param>

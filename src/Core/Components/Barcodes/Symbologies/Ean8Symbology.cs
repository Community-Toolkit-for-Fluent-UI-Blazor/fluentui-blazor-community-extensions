...
public sealed class Ean8Symbology : ComponentBase, ISymbology
{
    /// <summary>
    ...
    /// </summary>
    public Symbology Symbology => Symbology.Ean8;
    ...
    protected override void OnInitialized()
    {
        ...
        if (Parent is null)
        {
            throw new InvalidOperationException("The Ean8Symbology component must be used within a FluentCxBarcode component.");
        }

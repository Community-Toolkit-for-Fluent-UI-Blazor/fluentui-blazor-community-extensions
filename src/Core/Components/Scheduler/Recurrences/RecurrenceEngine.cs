...
public static class RecurrenceEngine
{
    ...
    /// cref="DateTime.MaxValue"/> instead of throwing an exception.</remarks>
    ...
    /// <returns>The resulting year after addition, or <see cref="DateTime.MaxValue"/> if the calculation exceeds the

    ...
    : ObserverItem
{
    ...
    /// </summary>
    private const string JavaScriptFile = "./_content/FluentUI.Blazor.Community.Components/Components/AudioVideo/Audio/FluentCxAudio.razor.js";
    ...
    /// </summary>
    private AudioVideoRepeatMode _repeatMode;

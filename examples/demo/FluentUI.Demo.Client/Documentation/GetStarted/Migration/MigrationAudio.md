...
- We remove third party dependencies, like Tag# and Ffmpeg. If you want to use this in v5 you'll need to provide a custom implementation of the `IAudioMetadataProvider` interface.

### Extract the audio metadata

To extract an audio metadata, you need to use a package like Tag#.
And you need to implement the IAudioMetadataProvider and register the service.

First : Create a TagLib file abstraction.
...
And after, implements the IAudioMetadataProvider like this :
    ...
    : IAudioMetadataProvider
{
    ...
    public AudioMetadata GetFromStream(string name, Stream stream)
    {
        try
        {
            ...
            {
                Descriptive = new AudioDescriptiveMetadata()
                {
                    Title = tag.Title,
                    Album = tag.Album,
                ...
                Technical = new AudioTechnicalMetadata()
                {
                ...
                Extended = new AudioExtendedMetadata()
                {
                ...
                Legal = new AudioLegalMetadata()
                {
                    Copyright = tag.Copyright,
                    Publisher = tag.Publisher,
                },

                Visual = new AudioVisualMetadata()
                {

...
/// </summary>
internal sealed class DeviceOrientationConverter : JsonConverter<DeviceOrientation>
{
    /// <inheritdoc />
    ...
    /// <inheritdoc />
    public override void Write(Utf8JsonWriter writer, DeviceOrientation value, JsonSerializerOptions options) => throw new NotImplementedException();
}

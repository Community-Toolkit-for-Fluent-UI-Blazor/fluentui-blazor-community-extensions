...
/// </summary>
internal sealed class BrowserConverter : JsonConverter<Browser>
{
    /// <inheritdoc />
    ...
    /// <inheritdoc />
    public override void Write(Utf8JsonWriter writer, Browser value, JsonSerializerOptions options) => throw new NotImplementedException();
}

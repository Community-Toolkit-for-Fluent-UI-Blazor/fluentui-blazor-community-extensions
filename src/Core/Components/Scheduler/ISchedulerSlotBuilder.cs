...
public interface ISchedulerSlotBuilder
{
    ...
    /// provided culture.
    /// </summary>
    /// <param name="localizer">An instance of <see cref="IFluentLocalizer"/> used to access localized resources for formatting slot data. This parameter is required for localization support.</param>
    ...
    IEnumerable<SchedulerSlot> GetSlots(

...
{
    /// <summary>
    /// Intializes a new instance of the <see cref="SchedulerBusinessHours{TItem}"/> class with the specified configuration.
    /// </summary>
    /// <param name="configuration">The library configuration used to initialize the component.</param>
    public SchedulerBusinessHours(LibraryConfiguration configuration)
        : base(configuration)
    {
    }

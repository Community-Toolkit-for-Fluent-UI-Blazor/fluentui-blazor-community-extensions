...
public sealed class SvgAnimateBuilder
{
    ...
    /// <summary>
    /// Sets the fill color for the SVG animation element.
    /// </summary>
    /// <param name="fill">The fill color to apply to the SVG element. This can be any valid CSS color value, such as a color name,
    /// hexadecimal, RGB, or RGBA value.</param>
    /// <returns>The current instance of <see cref="SvgAnimateBuilder"/> to allow method chaining.</returns>

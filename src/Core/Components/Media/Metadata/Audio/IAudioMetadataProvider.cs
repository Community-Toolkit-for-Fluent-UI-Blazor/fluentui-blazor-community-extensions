...
public interface IAudioMetadataProvider
{
    ...
    /// </summary>
    /// <param name="name">The name to associate with the audio metadata, which can be used for identification purposes. This parameter is optional and can be null or empty.</param>
    ...
    Task<AudioMetadata?> GetFromStreamAsync(string name, Stream stream);
}

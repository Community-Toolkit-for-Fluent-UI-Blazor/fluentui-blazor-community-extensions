...
/// structure for line chart layers.</remarks>
internal static class ChartLineSvgBuilder
{
    /// <summary>
    /// Builds the SVG elements for a line layer based on the provided payload and theme context.
    /// </summary>
    /// <param name="svg">The SVG builder used to construct the SVG elements.</param>
    /// <param name="payload">The payload containing the data and styling information for the line layer.</param>

...
/// <summary>
/// Represents configuration options for a Lootie animation.
/// </summary>
/// <remarks>This record is used to configure the behavior and rendering of a Lootie animation.  It includes
/// options for the animation's file path, playback settings, speed, and rendering type.</remarks>
/// <param name="Path">The file path to the Lootie animation. This must be a valid path to the animation file.</param>
...
/// default value is <see cref="LootieRenderer.Svg"/>.</param>
public record LootieOptions(
    string Path,
    bool Loop = true,
    bool Autoplay = true,
    double Speed = 1,
    LootieRenderer Renderer = LootieRenderer.Svg)
{
}

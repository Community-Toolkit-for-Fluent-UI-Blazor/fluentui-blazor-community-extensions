...
/// <summary>
/// Represents a button that toggles the shuffling state of a collection.
/// </summary>
/// <remarks>This component allows users to enable or disable shuffling of items in a collection. It provides
/// visual feedback through icons and labels that indicate the current shuffle state.</remarks>
    ...
    : FluentComponentBase
{
    ...
    /// </summary>
    public ShuffleButton(LibraryConfiguration configuration)
        : base(configuration)
    {

    ...
    : FluentComponentBase
{
    ...
    /// <summary>
    /// Initializes a new instance of the DotIndicator class using the specified library configuration.
    /// </summary>
    /// <param name="configuration">The configuration settings for the library that determine the behavior and available options for the
    /// DotIndicator instance. Cannot be null.</param>
    public DotIndicator(LibraryConfiguration configuration)
        : base(configuration)
    {
    }

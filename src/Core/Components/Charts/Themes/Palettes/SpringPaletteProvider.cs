...
/// <summary>
/// Represents a chart palette provider that generates a spring-themed color palette for chart components.
/// </summary>
internal sealed class SpringPaletteProvider : IChartPaletteProvider
{
    /// <summary>

...
{
    /// <summary>
    /// Represents whether the trail menu list is currently opened or closed.
    /// This state is used to manage the visibility of the menu list and the chevron icon's orientation.
    /// </summary>

...
{
    /// <summary>
    /// Initializes a new instance of the SchedulerNavigation class using the specified library configuration.
    /// </summary>
    /// <param name="configuration">The configuration settings for the library. Provides options and parameters required to initialize the scheduler
    /// navigation component. Cannot be null.</param>
    public SchedulerNavigation(LibraryConfiguration configuration)
        : base(configuration)
    {
    }

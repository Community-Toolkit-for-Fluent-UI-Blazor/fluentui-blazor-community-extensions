...
/// <summary>
/// Represents a category for a cookie item.
/// </summary>
public sealed record CookiePolicyEntry
{
    /// <summary>
    ...
    internal static CookiePolicyEntry CreateGoogleAnalyticsCookiePolicyEntry(string description)
    {
        return new()
        {
            Disabled = true,

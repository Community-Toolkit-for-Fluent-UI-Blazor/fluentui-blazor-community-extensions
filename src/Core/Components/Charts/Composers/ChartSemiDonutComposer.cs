...
using DS = FluentUI.Blazor.Community.Components.Charts.Series.SemiDonutSerie;

namespace FluentUI.Blazor.Community.Components.Charts.Composers;

/// <summary>
/// Represents a composer responsible for generating the necessary layers to render semi-donut charts.
/// </summary>
...
internal sealed class ChartSemiDonutComposer(
    string chartId,
    ...
    : ISurfaceComposer<CO>
{
        ...
        CO chartOptions)
    {
        ...
        for (var serieIndex = 0; serieIndex < filtered.Count; serieIndex++)
        {
            ...
            target.AddLayer(new SemiDonutLayer(

...
public sealed class StackedBarSerie
    : SerieBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="StackedBarSerie"/> class with the specified library configuration.
    /// </summary>
    /// <param name="configuration">The configuration settings for the Fluent UI Blazor library.</param>
    public StackedBarSerie(LibraryConfiguration configuration)
        : base(configuration)
    {
        Id = Identifier.NewId();
    }
    ...
    /// <inheritdoc />
    protected internal override ChartType ChartType => ChartType.StackedBar;

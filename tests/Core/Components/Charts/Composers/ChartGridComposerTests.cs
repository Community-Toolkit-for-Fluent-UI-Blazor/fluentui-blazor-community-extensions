...
public class ChartGridComposerTests
{
    ...
    public void ChartGridComposer_Compose_AddsGridLayer()
    {
        ...
        var chartOptions = new ChartOptions { DefaultGridOptions = new ChartGridOptions { ShowHorizontal = true, ShowVertical = true } };
    ...
    public void ChartGridComposer_Compose_SkipsWhenHidden()
    {
        ...
        var chartOptions = new ChartOptions { DefaultGridOptions = new ChartGridOptions { ShowHorizontal = false, ShowVertical = false } };

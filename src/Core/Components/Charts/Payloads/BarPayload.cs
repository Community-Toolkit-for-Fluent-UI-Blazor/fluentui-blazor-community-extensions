...
/// <summary>
/// Represents the payload for a bar in a bar chart layer.
/// </summary>
public sealed record BarPayload : ChartItemPayloadBase, IEquatable<BarPayload>
{
    /// <summary>
    ...
    /// <inheritdoc />
    public bool Equals(BarPayload? other)
    {
        if (other is null)
        {
            return false;

...
/// <summary>
/// Represents an item in an video playlist, including its associated track, selection state, and actions.
/// </summary>
    ...
    : FluentComponentBase
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="VideoPlaylistItem"/> class.
    /// </summary>
    public VideoPlaylistItem(LibraryConfiguration configuration) : base(configuration)
    {
        Id = $"video-playlist-item-{Identifier.NewId()}";
    }

    /// <summary>
    /// Gets or sets the video track item to be displayed in the playlist.
    /// </summary>
    [Parameter]
    ...
    /// </summary>
    [Parameter]
    public EventCallback<VideoTrackItem> OnSelected { get; set; }

...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SchedulerYearView{TItem}" /> class using the specified library configuration.
    /// </summary>
    /// <param name="configuration">The configuration settings used to initialize the <see cref="SchedulerYearView{TItem}" />. Cannot be null.</param>
    public SchedulerYearView(LibraryConfiguration configuration)
        : base(configuration)
    {
    }

...
- We remove third party dependencies, like Ffmpeg. If you want to use this in v5 you'll need to provide a custom implementation of the `IVideoMetadataProvider` interface.

### Extract the video metadata

To extract a video metadata, you need to use a package like ffmpegCore with ffprobe.
And you need to implement the IVideoMetadataProvider and register the service.

You implement the IVideoMetadataProvider like this :

...
{
    /// <summary>
    /// Initializes a new instance of the SchedulerTimelineView class using the specified library configuration.
    /// </summary>
    /// <param name="configuration">The configuration settings to be used for initializing the timeline view. Cannot be null.</param>
    public SchedulerTimelineView(LibraryConfiguration configuration)
        : base(configuration)
    { }

...
/// <summary>
/// Represents the segment bar payload.
/// </summary>
public sealed record PolarBarSegmentPayload
    : ChartItemPayloadBase
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the inner radius of the bar segment.
    /// </summary>
    public required double InnerRadius { get; init; }

    /// <summary>
    /// Gets the outer radius of the bar segment.
    /// </summary>

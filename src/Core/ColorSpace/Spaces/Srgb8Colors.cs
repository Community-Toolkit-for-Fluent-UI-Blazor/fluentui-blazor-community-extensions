...
/// <summary>
/// Provides a collection of standard CSS named colors and their corresponding sRGB values.
/// </summary>
/// <remarks>This class enables lookup of sRGB color values by CSS color name, using case-insensitive matching.
/// The color definitions are based on the standard CSS color specification and can be used to ensure consistency with
/// web color naming conventions.</remarks>
public static class Srgb8Colors
{
    /// <summary>
    /// Provides a mapping of CSS named color strings to their corresponding sRGB color values.
    /// </summary>
    /// <remarks>The dictionary uses case-insensitive string comparison to match CSS color names, allowing for
    /// flexible lookups regardless of letter casing. The color values are based on the standard CSS color
    /// definitions.</remarks>
    private static readonly Dictionary<string, Srgb8> CssNamedColors =
    ...
    /// <summary>
    /// Attempts to retrieve the sRGB color associated with the specified CSS color name.
    /// </summary>
    /// <remarks>This method does not throw an exception if the color name is not found. Use this method when
    /// the presence of the color name is uncertain.</remarks>
    /// <param name="name">The CSS color name to look up. The comparison is case-insensitive.</param>
    /// <param name="color">When this method returns, contains the sRGB color value associated with the specified name, if the name is
    /// found; otherwise, contains the default value.</param>
    /// <returns>true if the color name was found and the corresponding color was returned in color; otherwise, false.</returns>
    public static bool TryGetColor(string name, out Srgb8 color) => CssNamedColors.TryGetValue(name, out color);
}
